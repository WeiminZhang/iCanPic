...
;from rs232.asm
	EXTERN R2RxRecord,R2RxRecordType,R2RxRecordNode
...
;Right justify; Fosc/32; 7 AN channels
	...
	;Setup TMR0
	movlw	b'00001000'
	movwf	T0CON		;TMR0 enabled but ready
...
;-------toggle RTS to let pc know we have reset-----------
	bsf	STL_RS232_RTS
	call	GSIDelay5ms
	bcf	STL_RS232_RTS
...
;send back tmr0 on/off bit as bit0 of 2nd status byte
	...
	bsf	WREG,0	
	#ENDIF
	movwf	R2SubfunctionRecordData+2
